...
public class Main {
    ...
    private static void exibirMenu() {
        ...
        System.out.println("<1> Cadastrar br.newtonpaiva.com.Livro");
        System.out.println("<2> Pesquisar br.newtonpaiva.com.Livro por Preço");
        System.out.println("<3> Pesquisar br.newtonpaiva.com.Livro por Título");
        System.out.println("<4> Excluir br.newtonpaiva.com.Livro");
    ...
    private static void cadastrarLivro(Connection conn, Scanner scanner) throws SQLException {
        ...
        System.out.println("br.newtonpaiva.com.Livro cadastrado com sucesso!");
        System.out.println("-----------------------------");
    }
